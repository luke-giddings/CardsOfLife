...
export const EN = {
  ...
  "edu_university_grad.left.r0": "A university man at last — and you mean to make it count. The professions lie open before you.",
  "edu_university_grad.right": "Seek a steady place",
  "edu_university_grad.right.r0": "Degree in hand, you go looking for solid, respectable work.",
...
export const IT: Record<StringId, string> = {
  ...
  "edu_university_grad.left.r0": "Un uomo d'università, finalmente — e intendi farlo valere. Le professioni ti si aprono davanti.",
  "edu_university_grad.right": "Cercare un posto sicuro",
  "edu_university_grad.right.r0": "Laurea in mano, vai in cerca di un lavoro solido e rispettabile.",
