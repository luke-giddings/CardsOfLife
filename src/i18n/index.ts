...
export const EN = {
  ...
  "job_unemployed_offer.prompt": "Word gets round that you're after work. There's honest positions going.",
  ...
  "job_unemployed_offer.left.r1": "They want someone who can read a ledger and cipher — and that's not you. Turned away at the door.",
...
export const IT: Record<StringId, string> = {
  ...
  "job_unemployed_offer.prompt": "Si sparge la voce che cerchi lavoro. Ci sono dei posti onesti liberi.",
  ...
  "job_unemployed_offer.left.r1": "Vogliono qualcuno che sappia leggere un registro e far di conto — e non sei tu. Respinto sulla porta.",
