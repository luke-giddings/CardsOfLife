...
export const EN = {
  ...
  "ya_adult.right.r0": "No time to rest — there's a living to wring from the world. You throw yourself at it, and it takes its toll.",
...
export const IT: Record<StringId, string> = {
  ...
  "ya_adult.right.r0": "Non c'è tempo di riposare — c'è da strappare al mondo di che vivere. Ti ci getti, e ne paghi il prezzo.",
