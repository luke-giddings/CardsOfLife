...
export const EN = {
  ...
  "child_accident.right": "Freeze",
  "child_accident.right.r0": "It clips you and flings you aside — battered, but breathing.",
  "child_accident.right.r1": "You freeze. The wheels do not.",
...
export const IT: Record<StringId, string> = {
  ...
  "child_accident.right": "Bloccarti",
  "child_accident.right.r0": "Ti sfiora e ti scaraventa di lato — pesto, ma vivo.",
  "child_accident.right.r1": "Ti blocchi. Le ruote no.",
