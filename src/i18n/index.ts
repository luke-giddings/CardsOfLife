...
export const EN = {
  ...
  "job_criminal_job.left.r0": "Gold and warm from his pocket. A fine haul — and a colder thing in your chest.",
  "job_criminal_job.right": "Small pickings only",
  "job_criminal_job.right.r0": "A handkerchief and a few coppers. Barely worth it, but you sleep easy.",
...
export const IT: Record<StringId, string> = {
  ...
  "job_criminal_job.left.r0": "Oro e caldo dalla sua tasca. Un bel bottino — e qualcosa di più freddo nel petto.",
  "job_criminal_job.right": "Solo piccoli furti",
  "job_criminal_job.right.r0": "Un fazzoletto e qualche spicciolo. Appena vale la pena, ma dormi tranquillo.",
