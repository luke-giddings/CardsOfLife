        ...
        },
        {
          ...
          options: {
            left: {
              ...
              outcomes: [
                { if: { traits: { relBrotherLove: { min: 25 }, relBrotherDistance: { max: 24 } } }, result: "rel_bro_fate.left.r0", effects: { setTraitsHidden: { relBrotherCooldown: 4 }, vitals: { happiness: "++", spirit: "+" }, setTraits: { relBrotherStoryDone: true } } },
                { if: { traits: { relBrotherLove: { min: 25 } } }, result: "rel_bro_fate.left.r1", effects: { setTraitsHidden: { relBrotherCooldown: 4 }, vitals: { happiness: "+", spirit: "+" }, setTraits: { relBrotherStoryDone: true } } },
                { if: { traits: { relBrotherLove: { min: 0 } } }, result: "rel_bro_fate.left.r2", effects: { setTraitsHidden: { relBrotherCooldown: 4 }, vitals: { happiness: "+" }, setTraits: { relBrotherStoryDone: true } } },
                { result: "rel_bro_fate.left.r3", effects: { setTraitsHidden: { relBrotherCooldown: 4 }, vitals: { happiness: "-", spirit: "-" }, setTraits: { relBrotherStoryDone: true } } },
              ],
            },
            right: {
              label: "rel_bro_fate.right", // make your peace from afar
              outcomes: [
                { if: { traits: { relBrotherLove: { min: 25 } } }, result: "rel_bro_fate.right.r0", effects: { setTraitsHidden: { relBrotherCooldown: 4 }, vitals: { spirit: "+" }, setTraits: { relBrotherStoryDone: true } } },
                { if: { traits: { relBrotherLove: { min: 0 } } }, result: "rel_bro_fate.right.r1", effects: { setTraitsHidden: { relBrotherCooldown: 4 }, vitals: { spirit: "+" }, setTraits: { relBrotherStoryDone: true } } },
                { result: "rel_bro_fate.right.r2", effects: { setTraitsHidden: { relBrotherCooldown: 4 }, vitals: { spirit: "--" }, setTraits: { relBrotherStoryDone: true } } },
              ],
            },
          },
        },
